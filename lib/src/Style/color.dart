...
class AppCommonColors{
  ...
  static const Color pageIndicatorActive = Color(0xff1B5664);
  static const Color pageIndicatorInActive = Color(0x4C000000);
  static const Color darkGreen = Color(0xff1B5664);
  ///MediaColors
  static const Color charlevoisienColor = Color(0xFF95BC5C);
  static const Color manicColor = Color(0xFFDC373E);
  static const Color nordColor = Color(0xFF307BB7);
...
class AppTextColors {
  ...
  static const Color darkGrey = Color(0xff1A515c);
  ...
  static Color get textGrey => const Color(0xffAEA6A0);
}
...
class AppBgColors{
  ...
  static Color get whiteBg => const Color(0xffFFFFFF);
  static const Color black = Color(0xff000000);
  ...
  static const Color green = Color(0xff8CB64E);
  static const Color darkGreen = Color(0xff1B5664);
  ///MediaColors
  static const Color charlevoisienColor = Color(0xFF95BC5C);
  static const Color manicColor = Color(0xFFDC373E);
